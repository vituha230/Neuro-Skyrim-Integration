...
- Backup (copy and rename) `...\Skyrim Special EditionData\Scripts` folder; copy `Scripts` folder from `scripts_compiled` folder into `...\Skyrim Special Edition\Data\` folder, agree to replace files (some vanila files were changed).
